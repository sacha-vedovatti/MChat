...
export function ChannelSidebar({ server, user, channels, activeChannelId, onSelect, onCreateChannel, onOpenSettings, onOpenServerSettings }: { server: Server; user: User; channels: Channel[]; activeChannelId: string | null; onSelect: (id: string) => void; onCreateChannel: () => void; onOpenSettings: () => void; onOpenServerSettings: () => void }) {
