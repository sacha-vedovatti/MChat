...
export function ServerRail({ servers, activeServerId, onSelect, onCreate, onLogout }: { servers: Server[]; activeServerId: string | null; onSelect: (id: string) => void; onCreate: () => void; onLogout: () => void }) {
